...
with st.sidebar:
    ...
    көмегімен **адамның жасы мен жынысын** 
    анықтайды.
...
if page == "🏠 Басты бет":
    ...
    with col1:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Модель дәлдігі</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Оқыту суреттері</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Оқыту эпохасы</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Тапсырма</div>
        </div>
        """, unsafe_allow_html=True)
...
# ============================================
    ...
    <div class="info-box">
        ...
        <p>Жүйе сіздің бетіңізді табады, нейрон желі арқылы 
        талдау жасайды және сіздің жасыңыз бен жынысыңызды болжайды.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    mode = st.radio(
        "🎯 **Режимді таңдаңыз:**",
        ["📷 Камера (нақты уақыт)", "🖼️ Сурет жүктеу"],
        horizontal=True
    )
            ...
            if not boxes:
                ...
                for i, r in enumerate(results, 1):
                    ...
                    with col1:
                        st.markdown(f"""
                        <div class="metric-card">
                            <div class="metric-label">Бет #{i}</div>
                    ...
                    with col2:
                        st.markdown(f"""
                        <div class="metric-card">
                            <div class="metric-label">Жасы</div>
                            <div class="metric-value">{r['age']}</div>
                        </div>
                        """, unsafe_allow_html=True)
                    with col3:
                        st.markdown(f"""
                        <div class="metric-card">
                            <div class="metric-label">Жынысы</div>
                            <div class="metric-value">{r['gender']}</div>
                        </div>
                        """, unsafe_allow_html=True)
...
# ============================================
    ...
    with col1:
        ...
        <div class="metric-card">
            <h3>🏥 Медицина</h3>
            <p>Рентген суреттерінен ауруларды табу</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="metric-card">
            <h3>🚗 Көлік</h3>
            <p>Автопилотты автокөліктер (Tesla)</p>
        </div>
        """, unsafe_allow_html=True)
...
# ============================================
    ...
    with col1:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Жалпы дәлдік</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Жыныс дәлдігі</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Жас қатесі</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div class="metric-card">
            <div class="metric-value">100</div>
            <div class="metric-label">Эпохалар</div>
        </div>
        """, unsafe_allow_html=True)
...
# ============================================
    ...
    with col2:
        ...
        <div class="feature-card">
            ...
            Бұл жоба мектеп оқушыларына нейрон желілерді 
    ...
    <div class="success-box">
        ...
        Бұл жобаны жасауға көмектескен <b>ғылыми жетекшіме</b>, 
        <b>отбасыма</b> және <b>достарыма</b> алғысымды білдіремін. 
        Сондай-ақ <b>ашық кодты</b> жасап жариялаған бағдарламашыларға 
