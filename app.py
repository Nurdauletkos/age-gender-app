...
if page == "🏠 Басты бет":
    ...
    with col3:
        ...
        <div class="feature-card">
            <h3>📚 Оқыту бөлімі</h3>
            <p>Нейрондық желі қалай жұмыс істейтінін үйрену</p>
        </div>
        """, unsafe_allow_html=True)
    with col4:
        st.markdown("""
...
# 📚 НЕЙРОНДЫҚ ЖЕЛІ
    ...
    with col1:
        ...
        <div class="feature-card">
            ...
            Сондықтан біз көреміз, ойлаймыз, шешім қабылдаймыз.Нейрондық желі де адам миы секілді жұмыс жасайды.</p>
        </div>
        """, unsafe_allow_html=True)
    with col2:
        st.markdown("""
